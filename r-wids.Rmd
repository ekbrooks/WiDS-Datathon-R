...
final_pred <- predict(training_forest2, final_testing)
final_testing$patient_id <- final_patientid
final_testing$treatment_pd <- final_pred

final_testing <- final_testing %>% select(treatment_pd, patient_id)
write.csv(final_testing, "/Users/ebrooks/Documents/thesis/project/r-wids-datathon/data/submission.csv")
